...
<xsl:template match="item">
	...
	<div class='post'>
        ...
        <xsl:variable name="media_url" select="media:content/@url"/>
        <xsl:if test='$media_url!=""'>
          <div class='mediaContent'>
            <img src='{$media_url}' width='580px' height='350px'/>
          </div>
        </xsl:if>
        	...
        	<xsl:for-each select="$comment_items/rss/channel/item">
            	<div class='comment' style='width:100%;'>
              		<div style='float:left; width:90px;'>
                		<img src='{media:thumbnail/@url}' width='75px' height='50px' style='border-radius:10px;'/>
              		</div>
