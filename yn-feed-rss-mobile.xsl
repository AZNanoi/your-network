...
<xsl:template match="rss">
	<html>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
			...
			<link rel="stylesheet" type="text/css" href="yn-feed-style-mobile.css"/>
      ...
      <script src="yn-scripts.js" defer="defer"><xsl:value-of select="''"/></script>
        ...
        <img src="{channel/image/url}" width="30px" height="30px" style="float:left"/>
        <span class="subtitle_font" style="float:left; color:white;"><xsl:value-of select="channel/title"/></span>
						
						<span class="f_logo">Your Network</span>
					
            <a href="http://xml.csc.kth.se/~marang/DM2517/your-network/logout.php" style="text-decoration:none; color:white; float:right;">Log out</a>
			</div>
