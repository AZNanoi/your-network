  ...
  <div id="wrapper">
    ...
    <div id="feedContainer">
      <div class="updateStatus">
        ...
        <form action="yn-feed.php?id=3" autocomplete="off" enctype="multipart/form-data" method="post">
            ...
            <div style="float:left; width:420px; height:50px; margin-left:15px; ">
              ...
              <?php
                if(isset($_POST['submit'])){
                  ...
                  $strId=strval($id);
                  $postID=$strId.'_'.$hashedTime;
                  mysqli_query($link, "INSERT INTO posts VALUES('$id', '$postID', '$message', '$fileData', '$tags', '$dateStamp', 'null', '$fileName', '$fileType')");
                  header("location:yn-feed.php?id=3&userName=Helen Josson");
                }
                else{
                  echo "Only images or videos are allowed!";
                }
      ...
      <div class="newsFeed">
        <?php
          ...
          $query="SELECT * FROM posts WHERE id='$id' ORDER BY publishDate ASC";
            ...
            $returnstring .= "
                <div class='message'>
                  <div class='profilePic'>
                    <img src='showImage.php?id=".$id."' width='140px' height='90px' style='border-radius:10px;'/>
                  </div>
                  <span class='font-link' style='font-size:18px;'>".$userName."</span>
                  <span class='font-standard'>
                    <span style='line-height:0.7;'> added a new photo<br/>
                    in the album: <a href='' class='subtitle_font'>".$album."...</a><br/></span>
                    <span class='font-time'>".$dateStamp."hrs ago</span><br/>
                    <div style='padding-top:5px;'>".$message."</div>
                  </span>
                </div>
                <div class='mediaContent'>
                  <img src='showImage-posts.php?postID=".$postID."' width='580px' height='350px'/>
                </div>
