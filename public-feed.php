...
<rss version="2.0"
  ...
  <channel>
    ...
    <?php
      echo "<description>Public News Feed From All Apps</description>";
    ?>
...
";
    ...
    <image>
      <url>http://xml.csc.kth.se/~marang/DM2517/your-network/showImage.php?id=<?php echo $id; ?></url>
      <title>Profile image</title>
      <link>http://xml.csc.kth.se/~marang/DM2517/your-network/showImage.php?id=<?php echo $id; ?></link>
    </image>
    <?php
      require("dbc.php");
      $query="SELECT * FROM profiles JOIN posts ON (posts.uid=profiles.id)  ORDER BY created_time DESC LIMIT 3";
...
<?php include 'public-feed-postfix.php';?>